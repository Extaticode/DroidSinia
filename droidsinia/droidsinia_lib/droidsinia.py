...
Examples:
    ...
    * Scan target using default 50 most common plugins:
        %(tool_name)s TARGET
    '''  % dict(tool_name="droidsinia")

    parser = argparse.ArgumentParser(description='%s security tool' % "droidsinia".capitalize(), epilog=examples,
    ...
    parser.add_argument("-i","--interface", default="interface", metavar="INTERFACE")
...
if __name__ == "__main__" and __package__ is None:
    ...
    import droidsinia_lib
    __package__ = str("droidsinia_lib")
